...
class FramesDirectory_90(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 90 degree
        image_1 = np.load(self.files[index])[0::2, 0::2]
        image_2 = np.load(self.files[index+1])[0::2, 0::2]
...
class FramesDirectory_45(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 45 degree
        image_1 = np.load(self.files[index])[0::2, 1::2]
        image_2 = np.load(self.files[index+1])[0::2, 1::2]
...
class FramesDirectory_135(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 135 degree
        image_1 = np.load(self.files[index])[1::2, 0::2]
        image_2 = np.load(self.files[index+1])[1::2, 0::2]
...
class FramesDirectory_0(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        # 0 degree
        image_1 = np.load(self.files[index])[1::2, 1::2]
        image_2 = np.load(self.files[index+1])[1::2, 1::2]
